...
public class GLCamera2D implements Camera2D
{
	...
	public void setViewportAndMatrices() 
	{
		...
		m_frustum.m_minX = m_position.m_x - m_frustumWidth * m_zoom / 2;
		m_frustum.m_maxX = m_position.m_x + m_frustumWidth * m_zoom / 2;
		m_frustum.m_minY = m_position.m_y - m_frustumHeight * m_zoom / 2;
		m_frustum.m_maxY = m_position.m_y + m_frustumHeight * m_zoom / 2;
