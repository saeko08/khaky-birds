...
public class ZombieVisual extends EntityVisual 
{
	...
	public ZombieVisual( ResourceManager resMgr, Entity entity ) 
	{
		...
		// load animations
		Animation observingZombie = resMgr.getResource( Animation.class, "khaky_birds_prototype/animations/zombie/observing.xml");
		Animation wanderingZombie = resMgr.getResource( Animation.class, "khaky_birds_prototype/animations/zombie/wandering.xml");
		//we may add this animation in the future
		//Animation shittedZombie = resMgr.getResource( Animation.class, "khaky_birds_prototype/animations/zombie/shitted.xml");		
